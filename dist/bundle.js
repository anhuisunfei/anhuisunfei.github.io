...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = exports.Main = function (_React$Component) {
		...
		_createClass(Main, [{
			key: 'handleGitHubLink',
			value: function handleGitHubLink() {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_appBar2.default, {
						...
						iconElementRight: _react2.default.createElement(_iconButton2.default, { onClick: this.handleGitHubLink, iconClassName: 'muidocs-icon-custom-github' })
					}),
	...
	var AppBar = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    if (title) {
	      ...
	      titleElement = typeof title === 'string' || title instanceof String ? _react2.default.createElement('h1', { onTouchTap: this._onTitleTouchTap,
	        style: this.prepareStyles(styles.title, styles.mainElement, titleStyle) }, title) : _react2.default.createElement('div', { onTouchTap: this._onTitleTouchTap,
	        style: this.prepareStyles(styles.title, styles.mainElement, titleStyle) }, title);
	    }
	    ...
	    if (showMenuIconButton) {
	      if (iconElementLeft) {
	        ...
	        menuElementLeft = _react2.default.createElement(_iconButton2.default, {
	          ...
	          onTouchTap: this._onLeftIconButtonTouchTap }, child);
	      }
	    }
	    ...
	    return _react2.default.createElement(_paper2.default, _extends({}, other, {
	      ...
	      zDepth: zDepth }), menuElementLeft, titleElement, menuElementRight, children);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _contextPure = __webpack_require__(182);
